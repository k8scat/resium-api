...
if __name__ == '__main__':
    resource_url = 'https://download.csdn.net/download/qq_24734285/12152656'
    source_id = resource_url.split('/')[-1]
    headers = {
    ...
    with requests.get(f'https://download.csdn.net/source/download?source_id={source_id}', headers=headers) as r:
        resp = r.json()
        print(resp)
        if resp['code'] == 200:
