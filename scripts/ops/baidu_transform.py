...
class BaiduTransformer:
    ...
    def get_token(self):
        ...
        with requests.get(
            "https://converter.baidu.com/detail?type=1&origin=wenkuConverterOther",
            headers=headers,
        ) as r:
...
def transform(filepath):
    ...
    with requests.get(
        ...
        if r.status_code == requests.codes.OK:
            soup = BeautifulSoup(r.text, "lxml")
            x_bce_security_token = soup.select(
                "div.sd-container div.sd-container-section"
            )[0].get("sessiontoken", None)

    filename = filepath.split(os.path.sep)[-1]
    with requests.put(
        f"https://bj.bcebos.com/v1/pdf365-test/share/c779a2c5b0ae2c2e60fc3019cf7f3e312.pdf"
    ) as r:
        pass
...
if __name__ == "__main__":
    ...
    try:
        ...
        upload_input.send_keys(
            "/Users/mac/Downloads/c779a2c5b0ae2c2e60fc3019cf7f3e31(2).pdf"
        )
        try:
